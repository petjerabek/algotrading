...
SKEW_K = TICK_SIZE_IN_CENTS / LOT_SIZE  # cents of price skew per unit of net position
...
class AutoTrader(BaseAutoTrader):
    ...
    def on_order_book_update_message(self, instrument: int, sequence_number: int, ask_prices: List[int],
        ...
        if instrument == Instrument.FUTURE:
            price_adjustment = -round(SKEW_K * self.position / TICK_SIZE_IN_CENTS) * TICK_SIZE_IN_CENTS
    ...
    def on_order_filled_message(self, client_order_id: int, price: int, volume: int) -> None:
        ...
        if client_order_id in self.bids:
            ...
            self.send_hedge_order(next(self.order_ids), Side.ASK, MINIMUM_BID//TICK_SIZE_IN_CENTS*TICK_SIZE_IN_CENTS, volume)
